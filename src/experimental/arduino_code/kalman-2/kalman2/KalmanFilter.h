...
class Kalman
{
  public:
    ...
    void kalmanFilter_predict()
    {
      ...
      predCov[0][1] = 0;//lastCov[0][1] + dt*lastCov[1][1]                                      + Q[0][1];
      predCov[1][0] = 0;//lastCov[1][0] + dt*lastCov[1][1]                                      + Q[1][0];
    ...
    void kalmanFilter_update()
    {
      ...
      newCov[0][1] = 0;//(1 - K[0][0])*predCov[0][1] + K[0][1]*predCov[1][1];
      newCov[1][0] = 0;//K[1][0]*predCov[0][0] + (1 - K[1][1])*predCov[1][0];
