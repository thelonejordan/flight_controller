/*
 * Flight Controller.cpp
 *
 * Created: 28-06-2017 13:39:42
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 0.05;               //Gain setting for the roll P-controller
float pid_i_gain_roll = 0.001;              //Gain setting for the roll I-controller
float pid_d_gain_roll = 27.0;              //Gain setting for the roll D-controller
...
unsigned long timer[7], current_time;
...
int main(void)
{
	...
	battery_voltage = analogReadA0() * 0.003077;
    ...
    while (1){
		//65.5 = 1 deg/sec (check the data sheet of the MPU-6050 for more information).
		...
		//0.0006981317 = 0.004 * (3.142(PI) / 180degr) The Arduino sin function is in radians
		angle_pitch -= angle_roll * sin(gyro_yaw * 0.0006981317);                  //If the IMU has yawed transfer the roll angle to the pitch angel.
		angle_roll += angle_pitch * sin(gyro_yaw * 0.0006981317);                  //If the IMU has yawed transfer the pitch angle to the roll angel.
		...
		//0.000246 = 0.08 * 0.003077.
		battery_voltage = battery_voltage * 0.92 + analogReadA0() * 0.000246;
